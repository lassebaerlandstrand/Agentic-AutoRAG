...
_STOP_TOKENS: frozenset[str] = frozenset({
    "a", "an", "the", "of", "and", "or", "but", "if", "then", "else", "for", "to", "from",
    "in", "on", "at", "by", "with", "as", "is", "are", "was", "were", "be", "been", "being",
    "have", "has", "had", "do", "does", "did", "will", "would", "should", "could", "may",
    "might", "must", "can", "this", "that", "these", "those", "it", "its", "their", "there",
    "here", "he", "she", "they", "we", "you", "i", "him", "her", "them", "us", "me", "my",
    "your", "our", "his", "hers", "theirs", "which", "who", "whom", "what", "when", "where",
    "why", "how", "all", "any", "some", "no", "not", "nor", "only", "also", "too", "very",
    "just", "so", "than", "such", "own", "same", "each", "every", "other", "while", "during",
    "between", "among", "into", "onto", "off", "out", "up", "down", "over", "under", "again",
    "still", "yet", "always", "never", "often", "sometimes", "once", "two", "three", "many",
    "much", "more", "most", "less", "fewer", "new", "old", "high", "low", "big", "small",
    "good", "bad", "first", "last", "next", "early", "late", "different",
})
...
_CITATION_PATTERNS: tuple[re.Pattern[str], ...] = (
    ...
    re.compile(r"\([A-ZÀ-Ÿ][\w'’\-]+(?:\s+(?:et\s+al\.?|and\s+[A-ZÀ-Ÿ][\w'’\-]+))?(?:,?\s*\d{4}[a-z]?)?(?:;\s*[^)]+)*\)"),
